import React, { useState, useEffect, useContext } from "react"; // useState is used to manage state within a component, allowing you to store and update data. useEffect is used to perform side effects in a component, such as updating the document title, fetching data, or subscribing to events.
...
const Auth = (props) => {
    axios.defaults.withCredentials = true;  // for logged in always up to logout
